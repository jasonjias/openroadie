...
/// Map pins for the mistakes that have a recorded location — the system
/// balloon marker. Used on non-interactive maps (preview, day map);
/// the tappable full-screen map draws its own via TripMapView, where
/// the marker's selection bounce is disabled.
